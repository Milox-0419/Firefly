...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	mode: "fullscreen",
	// 文章页/非首页的壁纸模式，未设置时与 mode 相同（实现首页与文章页使用不同壁纸效果）
	postMode: "overlay",
	...
	src: {
		...
		desktop: ["assets/images/DesktopWallpaper/desktop.avif"],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: ["assets/images/MobileWallpaper/mobile.jpg"],
		// 背景视频播放地址
