...
export const zh_CN: Translation = {
	...
	// 打赏页面
	[Key.sponsor]: "支持",
	[Key.sponsorTitle]: "赞赏支持",
	[Key.sponsorDescription]:
		"如果我的内容对你有帮助，欢迎通过以下方式支持我，你的支持是我持续创作的动力！",
	[Key.sponsorMethods]: "支持方式",
	[Key.sponsorList]: "支持者列表",
	[Key.sponsorEmpty]: "暂无支持记录",
	[Key.sponsorAmount]: "金额",
	[Key.sponsorDate]: "日期",
	[Key.sponsorMessage]: "留言",
	[Key.sponsorAnonymous]: "匿名",
	[Key.scanToSponsor]: "扫码支持",
	[Key.sponsorGoTo]: "前往支持",
	[Key.sponsorButton]: "支持与分享",
	[Key.sponsorButtonText]:
		"如果这篇文章对你有帮助，欢迎分享给更多人或支持！",
	...
	[Key.visitStats]: "站点访问",
	[Key.visitStatsTotalPv]: "总访问量",
	[Key.visitStatsTotalUv]: "总访客数",
	[Key.today]: "今天",
